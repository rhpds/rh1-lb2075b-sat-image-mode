...
**Owner:** myee111
**Migrated from:** https://github.com/rhpds/zt-satellite-image-mode
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/rh1-lb2075b-sat-image-mode`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/rh1-lb2075b-sat-image-mode
   ```
3. `cd rh1-lb2075b-sat-image-mode`
